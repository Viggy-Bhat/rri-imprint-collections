...
export function ProfileCard({ researcher, profileImageUrl, items = [] }) {
  return (
    <aside className="w-full lg:w-72 xl:w-80 shrink-0">
      <section
        className="bg-amber-50/90 border border-red-100 p-5 rounded-2xl shadow-md xl:sticky xl:top-6"
        aria-labelledby="profile-summary-heading"
      >
        <h2 id="profile-summary-heading" className="font-serif text-xl text-red-800 border-b border-red-300 pb-3 mb-4">
          Profile Summary
        </h2>
        ...
        {profileImageUrl && (
          <ProtectedImage
            ...
            wrapperClassName="mb-4 rounded-xl overflow-hidden shadow-sm"
